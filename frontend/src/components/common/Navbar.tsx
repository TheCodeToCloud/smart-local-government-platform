...
const Navbar: React.FC = () => {
  ...
  const officerLinks = (
    <>
      ...
      <NavLink to="/officer/applications" className={navLinkClass} onClick={() => setMobileOpen(false)}>
        Review Applications
      </NavLink>
    </>
  );
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-1">
            ...
            {isAuthenticated && user?.role === 'officer' && officerLinks}
              ...
              <div className="relative" ref={dropdownRef}>
                ...
                {dropdownOpen && (
                  <div className="absolute right-0 mt-2 w-52 bg-white border border-slate-200 rounded-xl shadow-lg
                    ...
                    <div className="py-1">
                      <Link
                        to={user.role === 'admin' ? '/admin/profile' : user.role === 'officer' ? '/officer/profile' : '/profile'}
